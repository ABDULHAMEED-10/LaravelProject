  ...
  <body>
    ...
    <main class="mt-5 pt-3 fw-bold">
        ...
        <div style="padding-bottom:30px; "class="container-fluid page-body-wrapper">
           ...
           <form action="{{url('/')}}/Show" method="post" action="">
     
           <table>     
                <tr style="background-color: sandybrown; ">
                    <td style="padding:20px";>Plate Number</td>
                    <td style="padding:20px";>Speed</td>
                    <td style="padding:20px";>Condition</td>
                    <td style="padding:20px";>Engine Type</td>
                ...
                @foreach ($data as $data)
                  <tr align="center" style="background-color: lightgray;">
                      ...
                      <td>
                      <a href="{{url('update_view', $data->id)}}" class="btn btn-info" >Update</a>
